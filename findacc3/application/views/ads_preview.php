...
$full_contact_url1 = $baseurl . 'ads/contact1/' . $title_url . '/' . $ads_id .'/'.$user_id;
$full_contact_url2 = $baseurl . 'ads/detail/' . $title_url . '/' . $ads_id ;
...
<div id="contentContainer">
  <div id="contentHolder">
    <div id="contentLeft">
		...
		if(!empty($success))
		 {
		echo "<p id='success_full_ad_Page' class='success_notify'>$success</p>";
		 }
		$alert = $this->session->flashdata('alert'); 
		if(!empty($alert))
		{
			echo "<p id='alert_full_ad_Page' class='alert_notify'>$alert</p>";
		}?>
			
			
   		  <h2 class="fullAdhd flLeft">
			
				<?=$provider['street_address'].','?><span class="capitalTxt"><?=$provider['city'].','?></span><?=$provider['state'].' '.$provider['postal_code']?></h2>
		...
		<div id="mainDetails">
            <div id="imgHolder"> 
				...
				{
					?>
					<img class="detailimg" src="<?=$staticurl?>ads_upload/<?=$adsImages[0]['name']?>" />
					<?php										
				}
				else
				{
            	...
            	<div class="imageLinksHol">
					...
					<span class="viewcntr">&nbsp;0 Ad Views</span>  
            ...
            <div id="detailsArea">
            	<div id="detailsHeading">
					...
					<span class="proptyep"><?=$getPropertyType[$provider['rent_type']]?></span>
                  ...
                  <!--  <span class="floatLeft"><img src="<?=$staticurl?>images/tubIcon.gif" width="21" height="14" id="faTubIcon" /></span>
                    ...
                    <a href='<?=$full_contact_url;?>' widt='650'  heigh='535'  title='Contact Provider'  class='flRight prewcntbtn roundBor3 greybox' style='color:#fff;'>Contact Provider</a>
                   <br class="clearer" />
           	  </div>
