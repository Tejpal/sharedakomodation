		...
		<div id="searchForm" >
			<form action="<?=site_url("/ads/search/result/")?>" name="search-head" id="search-head" method="GET" >
				...
				<div id="communityBlock" > 
					...
					<input type="text" id="community" name="community" class="banBarField" title="Any"/>
					<br/>
					<div class="fieldHint">Helps finding accomodation in your own/preferred community.</div>
					<br/>					
				</div>		 
				<div id="findBlock">
                <div id="banRadio">
