...
if(r==true)
...
else
  {
    ...
    function checkAll()
    {
        ...
        var inputs = document.forms["inbox"].getElementsByTagName('input');
        var checkboxes = [];
	...
	<div id="contentHolder">
		<div id="contentLeft">
		<form name="inbox"  onSubmit="return false;" id="inbox" action="<?=$base_url?>user/multipledeletemessage_inbox" method="POST">
		  <div id="inboxPage">
				<h2>RECEIVED MESSAGES</h2>
				<div id="accMenu">
					<ul>
						<li class="selected"><a href="<?=$base_url?>user/inbox">Received Messages</a></li>
						<li><a href="<?=$base_url?>user/sentmessages">Sent Messages</a></li>
					</ul>
				</div>
                <br class="clearer" />
                <div id="inboxMessages01">
                	<div id="inboxHeader">
                    	...
                    	<div class="fromColumn floatLeft height30">From</div>
                        <div class="messageColumn floatLeft height30">Message</div>
                        <div class="recievedColumn floatLeft height30">Recieved</div>
					...
					<?php foreach($result as $key=>$row){?>
                    	<li>
                        	...
                        	<div class="fromColumn floatLeft height52">
                            	<span class="boldText"><?php echo $row['firstname'];?></span><br>
                                <a href="mailto:<?=$row['contact_email']?>"><?php echo $row['contact_email'];?></a>
                            </div>
                            ...
                            <div class="actionsColumn floatLeft height52">
                            	<a href="<?=$base_url?>user/readmessage/<?=$row['ads_message_id']?>">Reply</a><br>
				   ...
				   <div id="inboxFooter">
					...
					<? }else{ echo "<p style='padding:10px 0px 0px 30px; margin:0px;'><b>You have not received any messages yet</b></p>";}?> 
