...
//echo '<pre>';print_r($communities);echo '</pre>';
       ...
       <?php
        ...
        <p class="padbot10">
          ...
          <!--  <select name="occupation" id="occupation" class="selectFieldnw sf250">
                    ...
                    <option value="0" <?php if((!empty($adinfo[0]['occupation'])) && $adinfo[0]['occupation']==0) { ?>selected="selected" <?php } ?>>Student</option>
                    <option value="1" <?php if((!empty($adinfo[0]['occupation'])) && $adinfo[0]['occupation']==1) { ?>selected="selected" <?php } ?>>Professional</option>
                </select>
			-->
	 
			<?php	if(!empty($adinfo) && !empty($adinfo[0]['occupation']))
                    {
                        $occupation = $adinfo[0]['occupation'];
                    }	
					else
					{
					$occupation = 'Student';
					}							
                    echo displayDropdown(getOccupationType(), $name='occupation', $selected=array($occupation), $classes='selectFieldnw sf250');
            ?>	
        </p>
     </div>
