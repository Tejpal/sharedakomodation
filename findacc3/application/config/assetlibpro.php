...
|
*/
$config['alp_asset_dir'] = '/static/';//TRAILING SLASH!
$config['alp_cache_dir_css'] = '/static/compressed/';//TRAILING SLASH!
$config['alp_cache_dir_js'] = '/static/compressed/';//TRAILING SLASH!
...
|
*/
$config['alp_csstidy_basepath']    = "/plugins/csstidy-1.3/";
...
|
*/
$config['alp_jsmin']    = "/plugins/jsmin-1.1.1.php";
